...
//      inputSelector.parentNode.after(page.hm.tag.current);
//      inputSelector.parentNode.after(page.no.tag.current);
//      inputSelector.parentNode.after(page.yes.tag.current);
//    }
//    else{
